...
export const GMX_LENS_ABI = [
  {
    inputs: [
      { internalType: 'contract IGmxGlpManager', name: '_manager', type: 'address' },
  ...
  },
  {
    inputs: [],
    name: 'manager',
    outputs: [{ internalType: 'contract IGmxGlpManager', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'vault',
    outputs: [{ internalType: 'contract IGmxVault', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
];
